...
class Ip4Address extends ValueObjectComplex
{
    /**
     * @param mixed $value
     * @param mixed ...$other
    ...
    public function guard($value, ...$other): void
    {
        ...
        if (filter_var($value->getValue(), FILTER_VALIDATE_IP, FILTER_FLAG_IPV4) === false) {
            throw new InvalidVOArgumentException('Value is not a valid ip4 address.', $value);
        }
    }
